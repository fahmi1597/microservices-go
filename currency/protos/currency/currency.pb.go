...
type RateRequest struct {
	...
	Base Currencies `protobuf:"varint,1,opt,name=Base,json=base,proto3,enum=currency.Currencies" json:"Base,omitempty"`
	// Destination is the destination currency code for the rate
	Destination Currencies `protobuf:"varint,2,opt,name=Destination,json=destination,proto3,enum=currency.Currencies" json:"Destination,omitempty"`
}
...
type ErrorOrRateResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Message:
	//	*ErrorOrRateResponse_RateResponse
	//	*ErrorOrRateResponse_ErrorMessage
	Message isErrorOrRateResponse_Message `protobuf_oneof:"message"`
}

func (x *ErrorOrRateResponse) Reset() {
	*x = ErrorOrRateResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ErrorOrRateResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ErrorOrRateResponse) ProtoMessage() {}

func (x *ErrorOrRateResponse) ProtoReflect() protoreflect.Message {
	mi := &file_currency_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ErrorOrRateResponse.ProtoReflect.Descriptor instead.
func (*ErrorOrRateResponse) Descriptor() ([]byte, []int) {
	return file_currency_proto_rawDescGZIP(), []int{2}
}

func (m *ErrorOrRateResponse) GetMessage() isErrorOrRateResponse_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *ErrorOrRateResponse) GetRateResponse() *RateResponse {
	if x, ok := x.GetMessage().(*ErrorOrRateResponse_RateResponse); ok {
		return x.RateResponse
	}
	return nil
}

func (x *ErrorOrRateResponse) GetErrorMessage() *status.Status {
	if x, ok := x.GetMessage().(*ErrorOrRateResponse_ErrorMessage); ok {
		return x.ErrorMessage
	}
	return nil
}

type isErrorOrRateResponse_Message interface {
	isErrorOrRateResponse_Message()
}

type ErrorOrRateResponse_RateResponse struct {
	RateResponse *RateResponse `protobuf:"bytes,1,opt,name=rate_response,json=rateResponse,proto3,oneof"`
}

type ErrorOrRateResponse_ErrorMessage struct {
	ErrorMessage *status.Status `protobuf:"bytes,2,opt,name=error_message,json=errorMessage,proto3,oneof"`
}

func (*ErrorOrRateResponse_RateResponse) isErrorOrRateResponse_Message() {}

func (*ErrorOrRateResponse_ErrorMessage) isErrorOrRateResponse_Message() {}
...
var file_currency_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x52, 0x04, 0x62, 0x61, 0x73, 0x65, 0x12,
	...
	,
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0xb5, 0x02, 0x0a, 0x0a, 0x43, 0x75, 0x72,
	...
	,
...
var file_currency_proto_goTypes = []interface{}{
	...
	(*ErrorOrRateResponse)(nil), // 3: currency.ErrorOrRateResponse
...
var file_currency_proto_depIdxs = []int32{
	...
	2, // 4: currency.ErrorOrRateResponse.rate_response:type_name -> currency.RateResponse
	4, // 5: currency.ErrorOrRateResponse.error_message:type_name -> google.rpc.Status
	...
	3, // 9: currency.Currency.SubscribeRates:output_type -> currency.ErrorOrRateResponse
...
func file_currency_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_currency_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ErrorOrRateResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_currency_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*ErrorOrRateResponse_RateResponse)(nil),
		(*ErrorOrRateResponse_ErrorMessage)(nil),
	}
	type x struct{}
